...
<body>
  <div class="container" id="login-panel">
    <h1>سامانه مدیریت درسی مکتب خصوصی گام دانش</h1>
    <div class="school-info">
      <p><i class="fas fa-map-marker-alt"></i> آدرس: کابل، ناحیه هفتم، سرک ده مراد خان، عقب مسجد جامع کارته غوث الدین، مکتب خصوصی گام دانش</p>
      <p><i class="fas fa-phone"></i> شماره تماس:۰۷۲۸۱۲۱۸۹۶  </p>
      <p><i class="fab fa-whatsapp"></i> واتساپ: ۰۷۲۸۱۲۱۸۹۶</p>
      <p><i class="fab fa-telegram"></i> کانال تلگرام: <a href="#" target="_blank">مکتب خصوصی گام دانش</a></p>
      <p><i class="fab fa-facebook"></i> صفحه فیسبوک: <a href="#" target="_blank">مکتب خصوصی گام دانش</a></p>
    </div>
